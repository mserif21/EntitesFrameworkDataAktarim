...
namespace EntitesFrameworkDataAktarım
{
    ...
    public partial class NORTHWNDEntities : DbContext
    {
        ...
        public virtual DbSet<StoreVisits> StoreVisits { get; set; }
        ...
        public virtual DbSet<tblStudio> tblStudio { get; set; }
        ...
        public virtual DbSet<vwFilmSimple> vwFilmSimple { get; set; }
        ...
        public virtual ObjectResult<spExample_Result> spExample()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<spExample_Result>("spExample");
        }
    
        public virtual ObjectResult<spFilms_Result> spFilms(string certName, Nullable<int> minOscars)
        {
            var certNameParameter = certName != null ?
                new ObjectParameter("CertName", certName) :
                new ObjectParameter("CertName", typeof(string));
    
            var minOscarsParameter = minOscars.HasValue ?
                new ObjectParameter("MinOscars", minOscars) :
                new ObjectParameter("MinOscars", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<spFilms_Result>("spFilms", certNameParameter, minOscarsParameter);
        }
